...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        $kpis = [
            ['label' => 'Total Revenue', 'value' => Money::format($totalRevenue), 'change' => $paidOrders . ' paid', 'up' => true, 'icon' => 'trending-up', 'color' => 'gold'],
        ...
        foreach ($orderRows as $o) {
            ...
            $activity[] = [
                'icon' => 'package',
                'color' => 'blue',
                'message' => 'New order <strong>' . htmlspecialchars($o['order_number']) . '</strong> placed by ' . htmlspecialchars($name) . ' (' . Money::format((float)$o['grand_total']) . ')',
        ...
        foreach ($recent as $o) {
            $recent_orders[] = [
                ...
                'total'    => Money::format((float)$o['grand_total']),
