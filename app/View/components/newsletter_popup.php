        ...
        <div class="relative w-full max-w-md bg-[var(--card)] rounded-3xl border border-[var(--border)] shadow-2xl overflow-hidden pointer-events-auto">
            ...
            <div class="p-8 sm:p-10 text-center">
                ...
                <p class="text-[var(--text-muted)] text-[11px] mt-5 leading-relaxed">
                    ...
                    <a href="/terms-and-conditions" class="text-[var(--text-secondary)] underline hover:text-white transition-colors">Terms</a>
                    and
                    <a href="/privacy-policy" class="text-[var(--text-secondary)] underline hover:text-white transition-colors">Privacy Policy</a>.
                    Unsubscribe anytime.
                </p>
            </div>
        </div>
