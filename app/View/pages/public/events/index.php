...
<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs"><a href="/">Home</a><span>/</span><span>Events</span></div>
            ...
            <div class="cta-actions reveal" style="margin-top:30px">
                <a href="/events/corporate-meeting" class="btn btn-gold btn-lg">Corporate Meeting</a>
                <a href="/events/conference" class="btn btn-gold btn-lg">Conference</a>
                <a href="/events/dinner" class="btn btn-gold btn-lg">Dinner</a>
            </div>
        </div>
    </section>
    ...
    <section class="section" style="padding-top:20px">
        <div class="container">
            <div class="svc-list">
                <a class="svc-card reveal" href="/events/corporate-meeting">
                ...
                <a class="svc-card reveal d1" href="/events/conference">
                ...
                <a class="svc-card reveal d2" href="/events/dinner">
