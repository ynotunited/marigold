        ...
        <div class="container">
            <div class="success-state" style="padding: 30px 10px;">
                ...
                <div class="order-sum" style="max-width: 560px; margin: 0 auto 32px; text-align: left; background: var(--paper);">
                    ...
                    <div class="row"><span>Track your quote status in your <a href="/account/quotes" style="color: var(--gold-deep); font-weight: 700;">customer portal</a></span></div>
                </div>

                <div class="cta-actions">
                    <a href="/shop" class="btn btn-gold btn-lg">Continue browsing <span class="arr">&rarr;</span></a>
                    <a href="/account/quotes" class="btn btn-ghost btn-lg">View my quotes</a>
                </div>
