<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs reveal"><a href="/">Home</a><span>/</span><span>Request a Quote</span></div>
    ...
    <section class="section" style="padding-top: 0;">
        <div class="container" x-data="quoteBasket()">
            ...
            <form action="/quote-request" method="POST" enctype="multipart/form-data" class="quote-layout">
                ...
                <aside class="quote-side">
                    ...
                    <div class="q-card">
                        ...
                        <p class="q-legal">By submitting you agree to our <a href="/terms-and-conditions">Terms &amp; Conditions</a>.</p>
                    </div>
