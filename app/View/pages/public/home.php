    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-8 max-w-[1440px] pt-32 pb-24">
        <div class="max-w-2xl">
            ...
            <div id="hero-ctas" class="flex flex-col sm:flex-row gap-4">
                ...
                <a href="/quote-request" id="cta-quote"
...
<section class="section" style="padding-top:clamp(56px, 7vw, 96px)">
    <div class="container">
        <div class="section-head" style="display:flex;align-items:end;justify-content:space-between;gap:24px;flex-wrap:wrap;max-width:none">
            ...
            <a class="btn btn-ghost reveal" href="/shop">View all <span class="arr">→</span></a>
        </div>
        ...
        <div class="iconic-grid">
            ...
            foreach ($iconic_products as $i => $prod): ?>
                <a class="iconic-card reveal<?= $i % 4 ? ' d' . $i % 4 : '' ?>" href="/shop?cat=corporate-gifts">
                    <div class="ic-img">
            ...
            <div class="clients-track">
                ...
                foreach ($clients as $c): ?>
                    <span class="client-logo" title="<?= htmlspecialchars($c['name']) ?>">
                        <img src="/clients/<?= $c['file'] ?>" alt="<?= htmlspecialchars($c['name']) ?>" loading="lazy">
                    </span>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="steps three">
            ...
            foreach ($solutions as $i => $sol): ?>
                <div class="sol-card reveal<?= $i % 4 ? ' d' . $i % 4 : '' ?>">
                    ...
                    <a class="ct-link" href="/quote-request">Start a programme <span class="arr">→</span></a>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
...
<section class="section" style="padding-top:0">
    <div class="container">
        <div class="section-head" style="display:flex;align-items:end;justify-content:space-between;gap:24px;flex-wrap:wrap;max-width:none">
            ...
            <a class="btn btn-ghost reveal" href="/shop">View all products <span class="arr">→</span></a>
        </div>
...
<section class="section" style="background:var(--paper)">
    <div class="container">
        <div class="section-head" style="display:flex;align-items:end;justify-content:space-between;gap:24px;flex-wrap:wrap;max-width:none">
            ...
            <a class="btn btn-ghost reveal" href="/blog">View all articles <span class="arr">→</span></a>
        </div>
        ...
        <div class="blog-grid">
            ...
            foreach ($posts as $i => $post): ?>
                <a class="blog-card reveal<?= $i % 4 ? ' d' . $i % 4 : '' ?>" href="/blog/<?= $post['id'] ?>">
...
<section class="section dark cta">
    <div class="container">
        ...
        <div class="cta-actions reveal">
            <a href="/quote-request" class="btn btn-gold btn-lg">Request a Proposal <span class="arr">→</span></a>
            <a href="/shop" class="btn btn-ghost-light btn-lg">Browse Products</a>
        </div>
    </div>
</section>
