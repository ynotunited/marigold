...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="<?= app_url('/admin/reports') ?>" class="btn btn-secondary border border-[var(--border)] h-9 px-4 text-sm bg-[var(--surface)]">
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    <div class="xl:col-span-2 bg-[#111] border border-[var(--border)] rounded-[16px] overflow-hidden">
        <div class="p-6 border-b border-[var(--border)] flex items-center justify-between">
            ...
            <a href="<?= app_url('/admin/orders') ?>" class="text-sm text-[var(--gold)] hover:text-white transition-colors">View All</a>
        </div>
