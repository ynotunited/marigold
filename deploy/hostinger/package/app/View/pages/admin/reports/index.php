            ...
            <table class="w-full text-left whitespace-nowrap">
                ...
                <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--surface)]/40 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right text-sm font-bold">₦<?= number_format($c['spent']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
            ...
            <table class="w-full text-left whitespace-nowrap">
                ...
                <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--surface)]/40 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right text-sm text-[var(--gold)] font-bold">₦<?= number_format($m['total']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
...
<div class="space-y-6" x-show="tab === 'Products & Categories'" x-cloak>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-[#111] border border-[var(--border)] rounded-[16px] p-5">
            ...
            <p class="text-2xl font-bold font-manrope text-[var(--gold)]">₦<?= number_format($totalStockValue) ?></p>
        </div>
        <div class="bg-[#111] border border-[var(--border)] rounded-[16px] p-5">
            ...
            <table class="w-full text-left whitespace-nowrap">
                ...
                <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--surface)]/40 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right text-sm font-bold">₦<?= number_format($p['price']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
            ...
            <table class="w-full text-left whitespace-nowrap">
                ...
                <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--surface)]/40 transition-colors">
                        ...
                        <td class="px-5 py-3 text-right text-sm font-bold">₦<?= number_format($cat['stock_value']) ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
