...
<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            ...
            <div class="cta-actions reveal">
                <a href="<?= app_url('/shop') ?>" class="btn btn-gold btn-lg">Shop Now</a>
                <a href="<?= app_url('/quote-request') ?>" class="btn btn-ghost btn-lg">Request a Quote</a>
            </div>
        </div>
    </section>
    ...
    <section class="section" style="background: var(--cream);">
        <div class="container split">
            <div>
                ...
                <a href="<?= app_url('/contact') ?>" class="btn btn-ghost reveal">Talk to our Team</a>
            </div>
    ...
    <section class="section" style="background: var(--cream); border-top: 1px solid var(--line);">
        <div class="container">
            ...
            <div class="tag-list reveal" style="justify-content: center;">
                ...
                ?>
                    <a href="<?= app_url('/categories/') ?><?= $c['slug'] ?>" style="display: inline-flex; align-items: center; gap: 8px;">
                        <?= cat_icon($c['icon'], 15) ?>
    ...
    <section class="cta section">
        <div class="container">
            ...
            <div class="cta-actions reveal">
                <a href="<?= app_url('/quote-request') ?>" class="btn btn-gold btn-lg">Request a Quote</a>
                <a href="<?= app_url('/contact') ?>" class="btn btn-ghost-light btn-lg">Contact Us</a>
            </div>
        </div>
    </section>
</div>
