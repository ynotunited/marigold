...
<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs"><a href="<?= app_url('/') ?>">Home</a><span>/</span><span>Corporate Solutions</span></div>
            ...
            <div class="cta-actions reveal" style="margin-top: 32px;">
                <a href="<?= app_url('/quote-request') ?>" class="btn btn-gold btn-lg">Start a project <span class="arr">&rarr;</span></a>
            </div>
        </div>
    </section>
            ...
            <div class="sol-grid">
                ...
                foreach ($solutions as $sol): ?>
                    <div class="sol-card-lg reveal">
                        ...
                        <a href="<?= app_url('/quote-request') ?>" class="ct-link">Request a quote <span class="arr" style="display:inline-block;transition:transform .35s var(--ease);">&rarr;</span></a>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="section dark cta">
        <div class="container">
            ...
            <div class="cta-actions reveal">
                <a href="<?= app_url('/quote-request') ?>" class="btn btn-gold btn-lg">Start a project <span class="arr">&rarr;</span></a>
                <a href="<?= app_url('/contact') ?>" class="btn btn-ghost-light btn-lg">Talk to our team</a>
            </div>
        </div>
    </section>
