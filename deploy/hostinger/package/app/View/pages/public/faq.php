<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs"><a href="<?= app_url('/') ?>">Home</a><span>/</span><span>FAQ</span></div>
        ...
        <div class="container">
            <div x-data="{ q: '', active: null }">
                ...
                <p class="faq-none" x-show="q.trim() !== '' && $refs.faqList.querySelectorAll('.faq-item:not(.is-hidden)').length === 0">
                    No questions match your search. Try a different keyword or <a href="<?= app_url('/contact') ?>">contact our team</a>.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="section dark cta">
        <div class="container">
            ...
            <div class="cta-actions reveal">
                <a href="<?= app_url('/contact') ?>" class="btn btn-gold btn-lg">Contact support <span class="arr">&rarr;</span></a>
            </div>
        </div>
    </section>
