...
$orderCurrency = $order_page['currency'] ?? ($order['currency'] ?? 'NGN');
        ...
        <div class="container" style="max-width: 640px;">
            <div class="cart-panel" style="padding: 40px 34px;">
                ...
                <div class="order-sum" style="margin: 26px 0 0;">
                    ...
                    <div class="row"><span>Subtotal</span><span><?= \App\Core\Money::format((float) $order['subtotal'], $orderCurrency) ?></span></div>
                    <div class="row"><span>VAT</span><span><?= \App\Core\Money::format((float) $order['tax'], $orderCurrency) ?></span></div>
                    <div class="row"><span>Shipping</span><span><?= \App\Core\Money::format((float) $order['shipping'], $orderCurrency) ?></span></div>
