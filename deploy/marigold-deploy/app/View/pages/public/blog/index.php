    ...
    <div class="container blog-layout">
            ...
            <div class="blog-grid">
                <?php foreach ($posts as $post): ?>
                    <article class="blog-card reveal">
                        <a href="<?= app_url('/blog/') ?><?= $post['slug'] ?>" class="bc-img">
                        ...
                        <div class="bc-body">
                            ...
                            <h3><a href="<?= app_url('/blog/') ?><?= $post['slug'] ?>"><?= htmlspecialchars($post['title']) ?></a></h3>
                            <p><?= htmlspecialchars($post['excerpt']) ?></p>
                            <a href="<?= app_url('/blog/') ?><?= $post['slug'] ?>" class="read">
                                Read Article
        ...
        <aside class="blog-side">
            <div class="side-card side-search">
                ...
                <form action="<?= app_url('/search') ?>" method="get" class="field">
            ...
            <div class="side-card">
                ...
                <div class="side-list">
                    <a href="<?= app_url('/blog') ?>"><span>All Articles</span></a>
                    <a href="<?= app_url('/blog') ?>"><span>Corporate Gifting</span> <span>12</span></a>
                    <a href="<?= app_url('/blog') ?>"><span>Sustainability</span> <span>8</span></a>
                    <a href="<?= app_url('/blog') ?>"><span>Case Studies</span> <span>5</span></a>
                    <a href="<?= app_url('/blog') ?>"><span>Company News</span> <span>3</span></a>
                </div>
            </div>
            ...
            <div class="side-card">
                ...
                <div class="tag-list">
                    <a href="<?= app_url('/blog') ?>">Premium</a>
                    <a href="<?= app_url('/blog') ?>">Leather</a>
                    <a href="<?= app_url('/blog') ?>">Tech</a>
                    <a href="<?= app_url('/blog') ?>">Customization</a>
                    <a href="<?= app_url('/blog') ?>">Employee Appreciation</a>
                </div>
            </div>
        </aside>
    </div>
