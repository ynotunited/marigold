...
<?php
$dinnerImages = [
    ['Dinner-01.jpg', 'Executive Gift Sets'],
    ['Dinner -02.jpg', 'Table Gifts & Guest Favors'],
    ['Dinner-03.jpg', 'Premium Drinkware & Glassware'],
    ['Dinner-04.jpg', 'Event Branding Materials'],
    ['Dinner-05.jpg', 'Awards & Recognition Gifts'],
    ['Dinner-06.jpg', 'Luxury Packaging Solutions'],
];
?>
...
<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs"><a href="<?= app_url('/') ?>">Home</a><span>/</span><a href="<?= app_url('/events') ?>">Events</a><span>/</span><span>Dinner</span></div>
    ...
    <section class="section">
        <div class="container split">
            <div class="reveal">
                ...
                <p class="lead" style="margin-bottom:18px">We understand that corporate dinners are more than social gatherings — they are opportunities to reinforce relationships, communicate appreciation, and leave a lasting impression on guests. Our team works closely with clients to provide products that reflect the prestige and purpose of each event.</p>
            ...
            <div class="visual reveal d1">
                <img src="<?= app_url('/pages/dinners/Dinner%20-02.jpg') ?>" alt="Elegant corporate dinner gift and table setting">
    ...
    <section class="section" style="padding-top:0">
        <div class="container">
            <div class="section-head center">
                ...
                <h2 class="display h2 reveal">Evenings, Crafted with Elegance</h2>
                <p class="lead reveal" style="margin-top:14px">From the table to the gift table, every detail is designed to reflect the prestige and purpose of your occasion.</p>
            </div>

            <div class="slider-shell reveal">
                <div class="swiper meeting-slider">
                    <div class="swiper-wrapper">
                        <?php foreach ($dinnerImages as $img): ?>
                            <div class="swiper-slide">
                                <div class="ms-card">
                                    <img src="<?= app_url('/pages/dinners/' . rawurlencode($img[0])) ?>" alt="<?= htmlspecialchars($img[1]) ?>" loading="lazy">
