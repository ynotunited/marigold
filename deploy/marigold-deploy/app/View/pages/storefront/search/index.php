<div style="background: var(--ivory); color: var(--ink);">
    ...
    <section class="page-hero">
        <div class="container">
            <div class="crumbs"><a href="<?= app_url('/') ?>">Home</a><span>/</span><span>Search</span></div>
            ...
            <div class="shop-layout">
                ...
                <aside class="shop-side reveal d1">
                    <div class="side-card">
                        ...
                        <div class="side-list">
                            <a class="active" href="<?= app_url('/search?q=') ?><?= urlencode($query) ?>"><span>Notebooks</span> <span>4</span></a>
                            <a href="<?= app_url('/search?q=') ?><?= urlencode($query) ?>"><span>Gift Sets</span> <span>12</span></a>
                            <a href="<?= app_url('/search?q=') ?><?= urlencode($query) ?>"><span>Drinkware</span> <span>8</span></a>
                        </div>
                    </div>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="pgrid search-grid">
                        ...
                        <article class="pcard reveal">
                            <div class="img-wrap">
                                <a class="img-link" href="<?= app_url('/product/') ?><?= $p['id'] ?>" aria-label="View <?= htmlspecialchars($p['name']) ?>">
                            ...
                            <div class="p-body">
                                ...
                                <a class="p-name" href="<?= app_url('/product/') ?><?= $p['id'] ?>"><?= htmlspecialchars($p['name']) ?></a>
                                <div class="p-foot">
                                    <span class="price"><?= \App\Core\Money::format((float)$p['price'], \App\Core\Session::get('currency') ?? 'NGN') ?></span>
                                    <a class="link-more" href="<?= app_url('/product/') ?><?= $p['id'] ?>">Details <span class="arr">&rarr;</span></a>
                                </div>
                            </div>
                        </article>
                        <?php endforeach; ?>
