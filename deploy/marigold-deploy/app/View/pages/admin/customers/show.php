    ...
    <div class="xl:col-span-2 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-[#111] border border-[var(--border)] rounded-[16px] p-5">
                ...
                <p class="text-2xl font-bold font-manrope text-[var(--gold)]"><?= money_format($customer['lifetime_value'], 'NGN') ?></p>
            </div>
            <div class="bg-[#111] border border-[var(--border)] rounded-[16px] p-5">
            ...
            <div class="bg-[#111] border border-[var(--border)] rounded-[16px] p-5">
                ...
                <p class="text-2xl font-bold font-manrope"><?= money_format($customer['avg_order_value'], 'NGN') ?></p>
            </div>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--surface)]/40 transition-colors group cursor-pointer" onclick="window.location='/admin/orders/<?= $ro['id'] ?>'">
                        ...
                        <td class="px-5 py-4 text-right font-bold text-sm text-[var(--gold)]"><?= money_format($ro['total'], 'NGN') ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
