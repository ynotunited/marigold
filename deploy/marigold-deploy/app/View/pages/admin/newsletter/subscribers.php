...
<div class="bg-[#111] border border-[var(--border)] rounded-[14px] p-4 mb-6 flex items-center gap-3 overflow-x-auto">
    <div class="relative flex-grow min-w-[200px] max-w-sm shrink-0"><i data-lucide="search" class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-muted)]"></i><input type="text" placeholder="Search by email…" class="input-field w-full pl-10 h-9 text-sm bg-[var(--surface)]"></div>
    <select class="input-field h-9 text-sm bg-[var(--surface)] pr-8 min-w-[140px] shrink-0"><option value="">Status</option><option>Subscribed</option><option>Unsubscribed</option></select>
    <select class="input-field h-9 text-sm bg-[var(--surface)] pr-8 min-w-[140px] shrink-0"><option value="">Source</option><option>Checkout</option><option>Footer Form</option><option>Popup</option></select>
</div>
