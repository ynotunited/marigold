<div class="flex items-center gap-4 mb-6">
    <a href="<?= app_url('/admin/newsletter/subscribers') ?>" class="text-[var(--text-secondary)] hover:text-white transition-colors"><i data-lucide="arrow-left" class="w-5 h-5"></i></a>
