                ...
                <tr class="hover:bg-[var(--surface)]/40 transition-colors group cursor-pointer" onclick="window.location='/admin/cms/<?= $p['id'] ?>/builder'">
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-2">
                            ...
                            <a href="<?= app_url('/admin/cms/') ?><?= $p['id'] ?>/builder" class="font-medium text-sm group-hover:text-[var(--gold)] transition-colors"><?= htmlspecialchars($p['title']) ?></a>
                        </div>
                    </td>
                    ...
                    <td class="px-5 py-4" onclick="event.stopPropagation()">
                        <div class="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <a href="<?= app_url('/admin/cms/') ?><?= $p['id'] ?>/builder" class="w-8 h-8 rounded-[6px] bg-[var(--surface)] border border-[var(--border)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--gold)] hover:border-[var(--gold)]/50 transition-colors" title="Open Builder"><i data-lucide="edit" class="w-3.5 h-3.5"></i></a>
