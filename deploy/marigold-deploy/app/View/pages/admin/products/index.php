            ...
            <tbody class="divide-y divide-[var(--border)]">
                ...
                <tr class="hover:bg-[var(--surface)]/40 transition-colors group">
                    ...
                    <td class="px-4 py-3 text-sm text-right">
                        <?php if ($p['sale_price']): ?>
                            <span class="font-bold text-[var(--gold)]"><?= money_format($p['sale_price'], 'NGN') ?></span>
                            <span class="text-[var(--text-muted)] line-through text-xs ml-1"><?= money_format($p['price'], 'NGN') ?></span>
                        <?php else: ?>
                            <span class="font-bold"><?= money_format($p['price'], 'NGN') ?></span>
                        <?php endif; ?>
                    </td>
