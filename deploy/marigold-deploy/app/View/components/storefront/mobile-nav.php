...
<nav class="md:hidden fixed bottom-0 left-0 w-full bg-[#111]/90 backdrop-blur-md border-t border-[var(--border)] z-50 pb-safe">
    <div class="flex justify-around items-center h-[60px]">
        <a href="<?= app_url('/') ?>" class="flex flex-col items-center justify-center w-full h-full text-[var(--gold)]">
            <i data-lucide="home" class="w-5 h-5 mb-1"></i>
            <span class="text-[10px] font-medium tracking-wide">Home</span>
        </a>
        <a href="<?= app_url('/shop') ?>" class="flex flex-col items-center justify-center w-full h-full text-[var(--text-secondary)] hover:text-white transition-colors">
        ...
        <a href="<?= app_url('/wishlist') ?>" class="flex flex-col items-center justify-center w-full h-full text-[var(--text-secondary)] hover:text-white transition-colors">
            <i data-lucide="heart" class="w-5 h-5 mb-1"></i>
            <span class="text-[10px] font-medium tracking-wide">Wishlist</span>
        </a>
        <a href="<?= app_url('/account/dashboard') ?>" class="flex flex-col items-center justify-center w-full h-full text-[var(--text-secondary)] hover:text-white transition-colors">
