...
class SearchController extends Controller
{
    ...
    public function ajaxSearch()
    {
        ...
        $results = [
            'Products' => [
                ['title' => 'Executive Leather Notebook', 'url' => '/product/executive-leather-notebook', 'image' => 'https://images.unsplash.com/photo-1531346878377-a541ba67f401?w=100', 'price' => Money::format(15000)],
                ['title' => 'Minimalist Pen Set', 'url' => '/product/minimalist-pen-set', 'image' => 'https://images.unsplash.com/photo-1585336261022-680e295ce3fe?w=100', 'price' => Money::format(8500)],
            ],
            'Categories' => [
